...
def comparison_3(stack1, stack2, stack3)
  sum_arr = [stack1.sum, stack2.sum, stack3.sum]
  until sum_arr[0] == sum_arr[1] && sum_arr[1] == sum_arr[2]
    sum_min = sum_arr.min
    sum_arr[0] -= stack1.shift if sum_arr[0] > sum_min
    sum_arr[1] -= stack2.shift if sum_arr[1] > sum_min
    sum_arr[2] -= stack3.shift if sum_arr[2] > sum_min
    #collection_arr = [stack1, stack2, stack3]
    #collection_arr.each.with_index do |arr, index|
    #  if sum_arr[index] > sum_min
